...
public class CidadeService {
    ...
    public Cidade salvar(Cidade cidade) {
        ...
        Estado estado = estadoRepository.findById(estadoId).orElseThrow(() -> new EntidadeNaoEncontradaException(String.format("Não existe um cadastro de estado com código %d", estadoId)));
    ...
    public void excluir(Long cidadeId) {
        try {
            ...
            throw new EntidadeEmUsoException(String.format("Cidade de código %d não pode ser removida, poi está em uso", cidadeId));
        }
    }
}
