package com.herval.food.core.openapi.adapter;
...
public class TypeNameExtractorAdapter extends TypeNameExtractor {
    ...
    private final PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviderPlugins;
    private final EnumTypeDeterminer enumTypeDeterminer;

    public TypeNameExtractorAdapter(TypeResolver typeResolver, PluginRegistry<TypeNameProviderPlugin, DocumentationType> typeNameProviderPlugins, EnumTypeDeterminer enumTypeDeterminer) {
        super(typeResolver, typeNameProviderPlugins, enumTypeDeterminer);
        this.typeResolver = typeResolver;
        this.typeNameProviderPlugins = typeNameProviderPlugins;
    ...
    private String typeName(ModelNameContext context) {
        TypeNameProviderPlugin selected = typeNameProviderPlugins.getPluginOrDefaultFor(context.getDocumentationType(),
